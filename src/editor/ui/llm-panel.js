        ...
        <div class="editor-section">
            ...
            <div class="accordion-content collapsed">
                ...
                <div class="panel-box">
                    ...
                    <select id="llm-provider" style="width:100%; padding:8px; border-radius:3px; font-size:0.85rem;">
                        ${providerOptions}
                    </select>
                    <div id="llm-provider-hint" style="font-size:0.7rem; color:#4CAF50; margin-top:6px; padding:4px 6px; background:rgba(76,175,80,0.1); border-radius:3px; display:none;"></div>
                </div>
                
                <div id="llm-api-fields" class="panel-box">
                    ...
                    <div style="margin-bottom:8px;">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
                            ...
                            <button id="llm-refresh-models" style="display:flex; align-items:center; gap:4px; font-size:0.65rem; background:transparent; border:1px solid #555; color:#888; padding:2px 8px; border-radius:2px; cursor:pointer;">
                                ${ICONS.sync} Refresh
                            </button>
                        </div>
                        <select id="llm-model-select" style="width:100%; padding:6px; border-radius:3px; font-size:0.8rem;">
                            <option value="">Loading models...</option>
                        </select>
                        <div id="llm-model-status" style="font-size:0.65rem; color:#888; margin-top:4px;"></div>
                        <input type="text" id="llm-model-custom" placeholder="Or enter custom model name" style="margin-top:6px; width:100%; padding:6px; background:transparent; border:1px solid #555; color:inherit; border-radius:3px; font-size:0.75rem;">
                    </div>
                ...
                <div style="margin-bottom:12px; border-top:1px solid #333; padding-top:10px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                        ...
                        <select id="llm-prompt-selector" style="font-size:0.75rem; background:transparent; color:inherit; border:1px solid #555; border-radius:3px; padding:3px 6px;">
                            <option value="refine">Refine Layout</option>
                            <option value="fill">OCR & Fill</option>
                            <option value="audit">Audit Config</option>
                        </select>
                    </div>
                    <textarea id="llm-user-prompt" class="code-editor" style="height:100px; font-size:0.75rem;"></textarea>
                    <div style="display:flex; justify-content:space-between; margin-top:4px;">
                        <span style="font-size:0.65rem; color:#555;">Use {{LAYOUT_JSON}}, {{CONFIG_JSON}}</span>
                        <button id="llm-reset-prompts" style="font-size:0.65rem; background:transparent; border:1px solid #555; color:#888; padding:2px 6px; border-radius:2px; cursor:pointer;">Reset</button>
                    </div>
                </div>

                <div style="display:flex; flex-direction:column; gap:8px; margin-bottom:10px;">
                    <button onclick="CYOA.editor.runLlmAction('refine')" class="action-btn" style="background:linear-gradient(135deg, #1e3a5f, #2d5a87) !important; color:white !important; text-align:left; font-size:0.8rem; padding:10px 12px; border:1px solid #3d7ab8 !important;">
                        <span style="float:right; font-size:1.1rem;"></span><strong>Refine Layout</strong>
                    </button>
                    <button onclick="CYOA.editor.runLlmAction('fill')" class="action-btn" style="background:linear-gradient(135deg, #5c2d6e, #8e24aa) !important; color:white !important; text-align:left; font-size:0.8rem; padding:10px 12px; border:1px solid #b04cc8 !important;">
                        <span style="float:right; font-size:1.1rem;"></span><strong>OCR & Fill</strong>
                    </button>
                    <button onclick="CYOA.editor.startAuditChat()" class="action-btn" style="background:linear-gradient(135deg, #1b5e20, #2e7d32) !important; color:white !important; text-align:left; font-size:0.8rem; padding:10px 12px; border:1px solid #4caf50 !important;">
                        <span style="float:right; font-size:1.1rem;"></span><strong>Interactive Audit</strong>
                    </button>
                </div>

                <div id="llm-manual-ui" class="panel-box" style="display:none; margin-top:12px; border:1px dashed #444;">
                    ...
                    <button id="btn-copy-debug-img" class="full-width-btn" style="background: #e65100 !important; color:white !important; margin-bottom:8px; font-size:0.8rem; display:flex; align-items:center; justify-content:center; gap:6px;" onclick="CYOA.editor.copyDebugImageToClipboard()">
