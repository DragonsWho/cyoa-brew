            ...
            <div class="accordion-content collapsed" style="padding: 0;">
                ...
                <div class="editor-section" style="border-bottom: 1px solid #333; padding-left: 5px;">
                    ...
                    <div class="accordion-content collapsed">
                        ...
                        <!-- ... (Shadow, Body for Disabled omitted for brevity as they are same structure) ... -->
                    </div>
                </div>
...
export const StyleSettingsMixin = {
    ...
    loadStyleSettings() {
        ...
        // Disabled fields omitted for brevity but logic exists in setupStyleListeners
    }
};