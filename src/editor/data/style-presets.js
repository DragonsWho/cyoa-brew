...
export const STANDARD_PRESETS = [
    {
        ...
        data: { borderColor: "#00ff00", borderWidth: 3, bodyColor: "#00ff00", bodyOpacity: 0.1, shadowColor: "#00ff00", shadowWidth: 15, radius: 12, css: "" }
    },
    {
        name: "Clean White",
        data: { borderColor: "#ffffff", borderWidth: 2, bodyColor: "#ffffff", bodyOpacity: 0.1, shadowColor: "#ffffff", shadowWidth: 10, radius: 8, css: "" }
    },
    {
        name: "Ocean Blue",
        data: { borderColor: "#00bfff", borderWidth: 3, bodyColor: "#00bfff", bodyOpacity: 0.15, shadowColor: "#00bfff", shadowWidth: 12, radius: 12, css: "" }
    },
    {
        name: "Crimson Alert",
        data: { borderColor: "#ff3333", borderWidth: 3, bodyColor: "#ff0000", bodyOpacity: 0.1, shadowColor: "#ff0000", shadowWidth: 15, radius: 4, css: "" }
    },
    {
        name: "Golden Legend",
        data: { borderColor: "#ffd700", borderWidth: 3, bodyColor: "#ffd700", bodyOpacity: 0.1, shadowColor: "#ffd700", shadowWidth: 20, radius: 15, css: "" }
    },
    {
        name: "Royal Purple",
        data: { borderColor: "#9932cc", borderWidth: 3, bodyColor: "#9932cc", bodyOpacity: 0.15, shadowColor: "#ba55d3", shadowWidth: 15, radius: 12, css: "" }
    },
    {
        name: "Stealth Gray",
        data: { borderColor: "#888888", borderWidth: 2, bodyColor: "#000000", bodyOpacity: 0.4, shadowColor: "#ffffff", shadowWidth: 5, radius: 2, css: "" }
    },
    {
        name: "Hot Pink",
        data: { borderColor: "#ff69b4", borderWidth: 3, bodyColor: "#ff1493", bodyOpacity: 0.1, shadowColor: "#ff69b4", shadowWidth: 15, radius: 20, css: "" }
    },
    {
        name: "Toxic Sludge",
        data: { borderColor: "#adff2f", borderWidth: 4, bodyColor: "#adff2f", bodyOpacity: 0.2, shadowColor: "#adff2f", shadowWidth: 10, radius: 10, css: "" }
    },
    {
        name: "Deep Void",
        data: { borderColor: "#000000", borderWidth: 4, bodyColor: "#000000", bodyOpacity: 0.6, shadowColor: "#ffffff", shadowWidth: 2, radius: 0, css: "" }
    }
];
